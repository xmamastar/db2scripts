-- BackupType: OFFLINE
-- AS support: YES
UPDATE COMMAND OPTIONS USING S ON Z ON /db2exports/db2scripts/logs/db2_generate_redirected_restore_script/vr8sap01a/db2acc/2021-03-03-14.52.15_SAMPLE_to_SAMPLE.out V ON;
